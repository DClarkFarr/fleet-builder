...
const form = reactive({
    name: props.shipClass?.name || "",
    sort: props.shipClass?.sort || props.nextSort,
});
...
const reset = () => {
    form.name = props.shipClass?.name || "";
    form.sort = props.shipClass?.sort || props.nextSort;
    isDirty.value = false;
};
